     ...
     <div class="form-group">
            ...
            {{Form::text('location',null, ['class' => 'form-control', 'placeholder' => 'Uenr Hostel, Domain Hostel'])}}
     </div>
     ...
     <div class="form-group">
            ...
            {{Form::text('price', null, ['class' => 'form-control', 'placeholder' => 'GHC'])}}
     </div>

     <div class="form-group">
            {{Form::label('type', 'Please specify the book type',['class' => 'text-dark'])}}
            {{Form::text('type', null, ['class' => 'form-control', 'placeholder' => 'Eg. Engineering,Chemistry,Natural Resources'])}}
     </div>

     <div class="form-group">
            {{Form::label('contact', 'Owner Contact',['class' => 'text-dark'])}}
            {{Form::text('contact', null, ['class' => 'form-control', 'placeholder' => 'Phone Number'])}}
     </div>
